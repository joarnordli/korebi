    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-6">
      ...
      >
        ...
        <button
          ...
          className="w-full py-3 rounded-xl border border-border bg-card font-body text-sm font-medium text-foreground flex items-center justify-center gap-3 hover:bg-secondary transition-colors mb-4"
        >
