...
const BASE_URL = "https://okiro.online";
...
const entries: SitemapEntry[] = [
  ...
  { path: "/welcome", lastmod: today, changefreq: "weekly", priority: "0.9" },
  { path: "/auth", lastmod: today, changefreq: "monthly", priority: "0.6" },
  { path: "/subscribe", lastmod: today, changefreq: "monthly", priority: "0.5" },
